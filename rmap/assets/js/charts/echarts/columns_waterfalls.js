                ...
                series: [
                    {
                        name: 'Evaporation',
                        type: 'bar',
                        data: [2.0, 4.9, 7.0, 23.2, 25.6, 35.7, 40.6,30, 32.6, 20.0, 6.4, 3.3],
                        itemStyle: {
                            normal: {
                                label: {
                                    show: true,
                    ...
                    },
                    {
                        name: 'Precipitation',
                        type: 'bar',
                        data: [2.6, 5.9, 9.0, 26.4, 38.7, 40.7, 25.6, 42.2, 48.7, 18.8, 6.0, 2.3],
                        itemStyle: {
                            normal: {
                                label: {
                                    show: true,
               ...
               /* toolbox: {
                ...
                series: [
                    ...
                    },
                    {
                        name: 'Television',
                        type: 'bar',
                        data: [213, 123, 432, 324, 432, 512, 170],
                        markLine: {
                            itemStyle: {
                                normal: {
                                    lineStyle: {
                    ...
                    },
                    {
                        ...
                        barWidth: 10,
                        stack: 'Television',
                        data: [432, 332, 231, 334, 190, 110, 120]
                    },
                    {
                        name: 'Google',
                        type: 'bar',
